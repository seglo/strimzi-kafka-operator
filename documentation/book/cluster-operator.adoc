...
that it can compare the state of the desired resources with the current cluster deployments in order to have
...
[[config_map_details]]
=== Format of the Kafka Connect cluster ConfigMap
